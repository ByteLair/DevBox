...
if docker ps | grep -q workspace-dev; then
    ...
    echo "🌐 IP da Rede: $SERVER_IP"
    echo ""
    
    # Perguntar tipo de instalação
    echo "❓ Como você vai usar o DevBox?"
    echo "   1) Uso pessoal (apenas nesta máquina)"
    echo "   2) Servidor de rede (outros computadores vão acessar)"
    echo ""
    read -p "Escolha [1-2]: " -n 1 -r INSTALL_TYPE
    echo ""
    echo ""
    
    if [[ $INSTALL_TYPE == "2" ]]; then
        # Instalação para rede/servidor
        echo "🌐 Configuração para Servidor de Rede"
        echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
        echo ""
        echo "🔌 Você (admin) conecta via SSH:"
        echo "   ssh -p 2222 developer@localhost"
        echo ""
        echo "👥 Outros usuários conectam via:"
        echo "   ssh -p 2222 developer@$SERVER_IP"
        echo ""
        echo "📝 Para adicionar novos usuários:"
        echo "   cd $INSTALL_DIR"
        echo "   ./add-user.sh 'ssh-rsa AAAA... usuario@email.com'"
        echo ""
        echo "🖥️  Instruções para sua equipe (VS Code Remote-SSH):"
        echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
        echo ""
        echo "   1. Instalar extensão 'Remote - SSH' no VS Code"
        echo ""
        echo "   2. Adicionar no arquivo ~/.ssh/config:"
        echo ""
        echo "      Host devbox"
        ...
        echo ""
        echo "   3. Enviar chave SSH pública para você:"
        echo "      cat ~/.ssh/id_rsa.pub"
        echo ""
        echo "   4. Após você adicionar a chave, conectar:"
        echo "      F1 > Remote-SSH: Connect to Host > devbox"
        echo ""
        echo "🔥 Firewall (se necessário):"
        echo "   sudo ufw allow 2222/tcp"
        echo ""
        echo "📚 Guia completo: $INSTALL_DIR/docs/pt-BR/ACESSO-REDE.md"
    else
        # Instalação local/pessoal
        echo "💻 Configuração para Uso Pessoal"
        echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
        echo ""
        ...
        echo ""
        echo "💡 Quer compartilhar com sua equipe?"
        echo "   Execute novamente e escolha opção 2, ou veja:"
        echo "   $INSTALL_DIR/docs/pt-BR/ACESSO-REDE.md"
    fi
